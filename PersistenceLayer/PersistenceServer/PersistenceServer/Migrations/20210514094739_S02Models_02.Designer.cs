...
namespace PersistenceServer.Migrations
{
    ...
    [Migration("20210514094739_S02Models_02")]
    partial class S02Models_02
    {
            ...
            modelBuilder.Entity("PersistenceServer.Models.Facility", b =>
                {
                    ...
                    b.Property<string>("TypeCity")
                        .HasColumnType("character varying(256)");

                    b.Property<string>("TypePostCode")
                        .HasColumnType("character varying(4)");

                    b.Property<string>("TypeStreet")
                        .HasColumnType("character varying(256)");

                    b.HasIndex("TypeCity", "TypeStreet", "TypePostCode");
            ...
            modelBuilder.Entity("PersistenceServer.Models.Facility", b =>
                {
                    ...
                    b.HasOne("PersistenceServer.Models.Campus", "Type")
                        .WithMany()
                        .HasForeignKey("TypeCity", "TypeStreet", "TypePostCode");
